...
class IngredientConversions(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'ingredient_conversions'
...
class RecipeIngredients(models.Model):
    ing_amount = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    unit = models.IntegerField(blank=True, null=True)
    ing = models.ForeignKey(Ingredients, models.DO_NOTHING, blank=True, null=True)
...
class RecipeInstructions(models.Model):
    ...
    instruction_number = models.IntegerField(primary_key=True)

    class Meta:
        managed = False
        db_table = 'recipe_instructions'
        unique_together = (('instruction_number', 'recipe'),)
